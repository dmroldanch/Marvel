...
import com.aptivist.challengeapis.core.di.NetworkModule_ProvideRetrofitFactory;
import com.aptivist.challengeapis.core.di.NetworkModule_ProvidesApiMarvelFactory;
import com.aptivist.challengeapis.core.di.NetworkModule_ProvidesHttpLoggingInterceptorFactory;
import com.aptivist.challengeapis.core.di.NetworkModule_ProvidesOkHttpClientFactory;
import com.aptivist.marvel.data.remote.ApiHelperImp;
import com.aptivist.marvel.data.remote.IApiMarvel;
import com.aptivist.marvel.presentation.MainActivity;
import com.aptivist.marvel.presentation.MainViewModel;
import com.aptivist.marvel.presentation.MainViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerMyApplication_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends MyApplication_HiltComponents.ViewModelC {
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return Collections.<String, Provider<ViewModel>>singletonMap("com.aptivist.marvel.presentation.MainViewModel", ((Provider) mainViewModelProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.aptivist.marvel.presentation.MainViewModel 
          return (T) new MainViewModel(singletonCImpl.apiHelperImp());
  ...
  private static final class SingletonCImpl extends MyApplication_HiltComponents.SingletonC {
    ...
    private Provider<IApiMarvel> providesApiMarvelProvider;
    ...
    private ApiHelperImp apiHelperImp() {
      return new ApiHelperImp(providesApiMarvelProvider.get());
    }
    ...
    private void initialize() {
      ...
      this.providesApiMarvelProvider = DoubleCheck.provider(new SwitchingProvider<IApiMarvel>(singletonCImpl, 0));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.aptivist.marvel.data.remote.IApiMarvel 
          return (T) NetworkModule_ProvidesApiMarvelFactory.providesApiMarvel(singletonCImpl.provideRetrofitProvider.get());

          case 1: // retrofit2.Retrofit 
          return (T) NetworkModule_ProvideRetrofitFactory.provideRetrofit(singletonCImpl.providesOkHttpClientProvider.get());
